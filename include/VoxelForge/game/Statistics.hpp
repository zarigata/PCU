...
namespace VanillaStats {
    // General
    constexpr const char* LEAVE_GAME = "poorcraftultra:leave_game";
    constexpr const char* PLAY_TIME = "poorcraftultra:play_time";
    constexpr const char* TOTAL_WORLD_TIME = "poorcraftultra:total_world_time";
    constexpr const char* TIME_SINCE_DEATH = "poorcraftultra:time_since_death";
    constexpr const char* TIME_SINCE_REST = "poorcraftultra:time_since_rest";
    constexpr const char* SNEAK_TIME = "poorcraftultra:sneak_time";
    constexpr const char* WALK_ONE_CM = "poorcraftultra:walk_one_cm";
    constexpr const char* CROUCH_ONE_CM = "poorcraftultra:crouch_one_cm";
    constexpr const char* SPRINT_ONE_CM = "poorcraftultra:sprint_one_cm";
    constexpr const char* WALK_ON_WATER_ONE_CM = "poorcraftultra:walk_on_water_one_cm";
    constexpr const char* FALL_ONE_CM = "poorcraftultra:fall_one_cm";
    constexpr const char* CLIMB_ONE_CM = "poorcraftultra:climb_one_cm";
    constexpr const char* FLY_ONE_CM = "poorcraftultra:fly_one_cm";
    constexpr const char* WALK_UNDER_WATER_ONE_CM = "poorcraftultra:walk_under_water_one_cm";
    constexpr const char* MINECART_ONE_CM = "poorcraftultra:minecart_one_cm";
    constexpr const char* BOAT_ONE_CM = "poorcraftultra:boat_one_cm";
    constexpr const char* PIG_ONE_CM = "poorcraftultra:pig_one_cm";
    constexpr const char* HORSE_ONE_CM = "poorcraftultra:horse_one_cm";
    constexpr const char* AVIATE_ONE_CM = "poorcraftultra:aviate_one_cm";
    constexpr const char* SWIM_ONE_CM = "poorcraftultra:swim_one_cm";
    constexpr const char* STRIDER_ONE_CM = "poorcraftultra:strider_one_cm";
    constexpr const char* JUMP = "poorcraftultra:jump";
    constexpr const char* DROP = "poorcraftultra:drop";
    constexpr const char* DAMAGE_DEALT = "poorcraftultra:damage_dealt";
    constexpr const char* DAMAGE_TAKEN = "poorcraftultra:damage_taken";
    constexpr const char* DEATHS = "poorcraftultra:deaths";
    constexpr const char* MOB_KILLS = "poorcraftultra:mob_kills";
    constexpr const char* ANIMALS_BRED = "poorcraftultra:animals_bred";
    constexpr const char* PLAYER_KILLS = "poorcraftultra:player_kills";
    constexpr const char* FISH_CAUGHT = "poorcraftultra:fish_caught";
    constexpr const char* TALKED_TO_VILLAGER = "poorcraftultra:talked_to_villager";
    constexpr const char* TRADED_WITH_VILLAGER = "poorcraftultra:traded_with_villager";
    constexpr const char* CAKES_EATEN = "poorcraftultra:cakes_eaten";
    constexpr const char* CAULDRON_FILLED = "poorcraftultra:cauldron_filled";
    constexpr const char* CAULDRON_USED = "poorcraftultra:cauldron_used";
    constexpr const char* ARMOR_CLEANED = "poorcraftultra:armor_cleaned";
    constexpr const char* BANNER_CLEANED = "poorcraftultra:banner_cleaned";
    constexpr const char* BREWINGSTAND_INTERACTION = "poorcraftultra:brewingstand_interaction";
    constexpr const char* BEACON_INTERACTION = "poorcraftultra:beacon_interaction";
    constexpr const char* ANVIL_INTERACTION = "poorcraftultra:anvil_interaction";
    constexpr const char* CRAFTING_TABLE_INTERACTION = "poorcraftultra:crafting_table_interaction";
    constexpr const char* FURNACE_INTERACTION = "poorcraftultra:furnace_interaction";
    constexpr const char* CHEST_OPENED = "poorcraftultra:chest_opened";
    constexpr const char* ENDERCHEST_OPENED = "poorcraftultra:enderchest_opened";
    constexpr const char* SHULKER_BOX_OPENED = "poorcraftultra:shulker_box_opened";
}
