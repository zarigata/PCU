...
## Build Status
- **Latest build:** ⏳ FIX PUSHED (2026-04-12 15:12 UTC)
  ...
  - Fix 13: `762148c` fix(build): fix VulkanCommandBuffer pointer comparison
...
- ⏳ Combat system + rendering build failed → 13 rounds of fixes pushed
