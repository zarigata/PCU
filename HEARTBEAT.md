...
## Build Status
- **Latest build:** ⏳ FIX PUSHED (2026-04-12 07:35 UTC)
  ...
  - Fix 3: `71ce40d` fix(build): add missing system class declarations and fix ProjectileEntity
...
- ⏳ Combat system build failed → 3 rounds of fixes pushed
