...
## Build Status
- **Latest build:** ⏳ FIX PUSHED (2026-04-12 17:02 UTC)
  ...
  - Fix 16: `8ffa424` fix(build): mark VulkanRenderPassBuilder::build as const
...
- ⏳ Combat system + rendering build failed → 16 rounds of fixes pushed
