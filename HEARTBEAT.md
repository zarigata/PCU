...
## Build Status
- **Latest build:** ⏳ FIX PUSHED (2026-04-12 18:41 UTC)
  ...
  - Fix 18: `340abd6` fix(build): add const qualifier to VulkanRenderPassBuilder::build implementation
  - Fix 19: `d0f199f` fix(build): fix all include paths to use VoxelForge namespace
  - Fixed 39 files total: Entity.hpp, Entity.cpp, EntityBase.cpp, LivingEntity.cpp, MobBase.cpp, ProjectileEntity.cpp, ItemEntity.cpp, VulkanDevice.cpp, VulkanContext.cpp, VulkanSwapchain.cpp, VulkanCommandBuffer.cpp, VulkanBuffer.cpp, VulkanRenderPass.hpp, VulkanRenderPass.cpp, VulkanFramebuffer.cpp, VulkanSync.cpp, Renderer.hpp, Renderer.cpp, ChunkRenderer.cpp, EntityRenderer.cpp, GUIRenderer.cpp, ShaderManager.cpp, TextureAtlas.cpp, AudioSystem.cpp, DayNightCycle.cpp, ModLoader.cpp, NetworkManager.cpp, CharacterController.cpp, CollisionManager.cpp, PhysicsSystem.cpp, LuaBindings.cpp, LuaEngine.cpp
...
- ⏳ Combat system + rendering build failed → 19 rounds of fixes pushed
